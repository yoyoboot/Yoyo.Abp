...
namespace Abp.Authorization.Roles
{
        ...
        where TRole : AbpRoleBase
    {
        ...
        /// <returns>List of permission setting informations</returns>
        Task<IList<PermissionGrantInfo>> GetPermissionsAsync(string roleId);
        ...
        /// <param name="roleId">Role id</param>
        /// <returns>List of permission setting informations</returns>
        IList<PermissionGrantInfo> GetPermissions(string roleId);
        ...
        /// <param name="permissionGrant">Permission grant setting info</param>
        /// <returns></returns>
        Task<bool> HasPermissionAsync(string roleId, PermissionGrantInfo permissionGrant);
