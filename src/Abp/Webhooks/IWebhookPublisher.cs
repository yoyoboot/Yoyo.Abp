...
namespace Abp.Webhooks
{
    public interface IWebhookPublisher
    {
        ...
        /// </para>
        /// </param>
        Task PublishAsync(string webhookName, object data, string tenantId, bool sendExactSameData = false);
        ...
        /// </para>
        /// </param>
        void Publish(string webhookName, object data, string tenantId, bool sendExactSameData = false);
        ...
        /// </para>
        /// </param>
        Task PublishAsync(string[] tenantIds, string webhookName, object data, bool sendExactSameData = false);
        ...
        /// </para>
        /// </param>
        void Publish(string[] tenantIds, string webhookName, object data, bool sendExactSameData = false);
    }
}
