...
namespace Abp.DynamicEntityProperties
{
    public class DynamicEntityPropertyManager : IDynamicEntityPropertyManager, ITransientDependency
    {
        ...
        private ITypedCache<string, DynamicEntityProperty> DynamicEntityPropertyCache => _cacheManager.GetCache<string, DynamicEntityProperty>(CacheName);
        ...
        public virtual DynamicEntityProperty Get(string id)
        {
        ...
        public virtual async Task<DynamicEntityProperty> GetAsync(string id)
        {
