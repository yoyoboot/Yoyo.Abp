...
namespace Abp.Notifications
{
    ...
    public interface IUserNotificationManager
    {
        ...
        Task<UserNotification> GetUserNotificationAsync(string tenantId, Guid userNotificationId);
        ...
        /// <param name="tenantId">Tenant Id</param>
        /// <param name="userNotificationId">The user notification id.</param>
        UserNotification GetUserNotification(string tenantId, Guid userNotificationId);
