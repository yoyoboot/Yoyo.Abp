...
namespace Abp.Notifications
{
    ...
    public interface INotificationSubscriptionManager
    {
        ...
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        Task<List<NotificationSubscription>> GetSubscriptionsAsync(string tenantId, string notificationName, EntityIdentifier entityIdentifier = null);
        ...
        /// <param name="notificationName">Name of the notification.</param>
        /// <param name="entityIdentifier">entity identifier</param>
        List<NotificationSubscription> GetSubscriptions(string tenantId, string notificationName, EntityIdentifier entityIdentifier = null);
