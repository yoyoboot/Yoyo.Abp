...
namespace Abp.Notifications
{
    ...
    public class NullNotificationStore : INotificationStore
    {
        ...
        public Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(string[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers = null)
        {
            return Task.FromResult(new List<NotificationSubscriptionInfo>());
        }
        ...
        public Task UpdateUserNotificationStateAsync(string notificationId, Guid userNotificationId, UserNotificationState state)
        {
            return Task.FromResult(0);
        }
        ...
        public Task DeleteUserNotificationAsync(string notificationId, Guid userNotificationId)
        {
            return Task.FromResult(0);
        }
        ...
        public Task<UserNotificationInfoWithNotificationInfo> GetUserNotificationWithNotificationOrNullAsync(string tenantId, Guid userNotificationId)
        {
        ...
        public List<NotificationSubscriptionInfo> GetSubscriptions(string[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers = null)
        {
            return new List<NotificationSubscriptionInfo>();
        }
        ...
        public UserNotificationInfoWithNotificationInfo GetUserNotificationWithNotificationOrNull(string tenantId, Guid userNotificationId)
        {
