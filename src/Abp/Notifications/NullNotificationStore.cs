...
namespace Abp.Notifications
{
    ...
    public class NullNotificationStore : INotificationStore
    {
        ...
        public Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(string[] tenantIds, string notificationName, string entityTypeName, string entityId)
        {
            return Task.FromResult(new List<NotificationSubscriptionInfo>());
        }
        ...
        public List<NotificationSubscriptionInfo> GetSubscriptions(string[] tenantIds, string notificationName, string entityTypeName, string entityId)
        {
            return new List<NotificationSubscriptionInfo>();
        }
