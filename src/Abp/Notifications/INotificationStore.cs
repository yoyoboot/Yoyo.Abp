...
namespace Abp.Notifications
{
    ...
    public interface INotificationStore
    {
        ...
        /// </summary>
        Task<List<NotificationSubscriptionInfo>> GetSubscriptionsAsync(string[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers);

        /// <summary>
        /// Gets subscriptions for a notification for specified tenant(s).
        /// </summary>
        List<NotificationSubscriptionInfo> GetSubscriptions(string[] tenantIds, string notificationName, string entityTypeName, string entityId, string targetNotifiers);
