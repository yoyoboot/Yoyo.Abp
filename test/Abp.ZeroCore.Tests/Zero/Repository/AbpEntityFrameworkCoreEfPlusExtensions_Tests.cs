...
public class AbpEntityFrameworkCoreBulkRepositoryExtensions_Tests : AbpZeroTestBase
{
    private readonly IRepository<Role> _roleRepository;
    private readonly IUnitOfWorkManager _unitOfWorkManager;

    public AbpEntityFrameworkCoreBulkRepositoryExtensions_Tests()
    {
    ...
    public async Task Should_Delete_All_Tenant_Roles_When_Using_BatchDeleteAll()
    {
        ...
        {
            // Act
            await _roleRepository.BatchDeleteAsync(r => r.Id !=null && r.Id != string.Empty);
    ...
    public async Task Should_Update_All_Tenant_Roles_When_Using_BatchUpdate()
    {
        ...
        {
            // Act
            await _roleRepository.BatchUpdateAsync(r => r.SetProperty(p => p.DisplayName, "Test"), r => r.Id !=null && r.Id != string.Empty);
